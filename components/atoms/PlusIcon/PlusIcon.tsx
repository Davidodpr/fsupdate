...
const PlusIcon = ({ color = 'var(--color-secondary-main)', onClick, disabled }: Props) => {
  ...
  return (
    ...
    >
      ...
      <path d="M16 11V21" stroke={customColor} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
    </svg>
  )
}
