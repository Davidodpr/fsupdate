...
export const contentContainerVariants = cva(['flex', 'flex-col', 'items-center', 'w-full', 'flex-auto', 'md:w-full md:flex md:flex-col md:items-center'])

export const popupHeaderVariants = cva(['!font-bold', '!text-[14px]', '!mt-2'])
...
export const accordionButtonWrapperVariants = cva(
  [
    ...
    'md:[&_button]:py-3 md:[&_button]:px-8',
...
export const buttonWrapperVariants = cva([
  ...
  'md:mt-0 md:min-w-[168px] md:w-max md:min-h-[48px] md:ml-6',
])
...
export const imageWrapperVariants = cva([
  ...
  'mb-6',
  'md:w-[120px] md:h-[120px] md:ml-8 md:mb-6',
])
...
export const faqWrapperVariants = cva([
  ...
  'bg-[var(--color-background-default)]',
  'gap-4',
  'md:flex md:flex-row md:px-0 md:items-center md:w-[629px] md:max-w-[629px]',
])
...
export const calendarWrapperVariants = cva([
  ...
  'gap-2.5',
  'self-stretch',
  'md:flex-row md:justify-center md:items-center md:py-4 md:px-0 md:gap-8 md:w-[629px] md:self-center',
])
