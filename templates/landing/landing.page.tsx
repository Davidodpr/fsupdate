        ...
        <div className="w-screen flex justify-center bg-white border-t border-gray-100 py-6">
          <div className="w-full px-4 md:px-8 max-w-[1232px] flex flex-col sm:flex-row items-center justify-center gap-4 sm:gap-10">
            ...
            <div className="flex items-center gap-8 sm:gap-12">
              ...
              <img src="/images/press/di-logo.svg" alt="Dagens industri" className="h-5 md:h-6 grayscale opacity-30" />
              {/* eslint-disable-next-line @next/next/no-img-element */}
              <img src="/images/press/aftonbladet-logo.svg" alt="Aftonbladet" className="h-5 md:h-6 grayscale opacity-30" />
              {/* eslint-disable-next-line @next/next/no-img-element */}
              <img src="/images/press/breakit-logo.svg" alt="Breakit" className="h-5 md:h-6 grayscale opacity-30" />
            </div>
          </div>
        </div>
