...
export const styledFlexVariants = cva(['p-0', 'md:py-0 md:pr-1 md:pl-4', 'text-[15px]'], {
  variants: {
    isFromAddress: {
...
export const sevenDayWarningWrapperVariants = cva(['py-3 px-4', 'rounded-lg', 'h-fit', 'bg-[#FFEBE8]', 'text-[#B8220B]', 'mx-auto mt-2', 'max-w-[490px]'])

export const popupWrapperVariants = cva(['text-[15px]', 'text-[#112E46]', 'max-w-[300px]'])
...
export const introSectionVariants = cva(
  ['flex', 'flex-col', 'justify-between', 'text-left', 'rounded-2xl', 'bg-white', 'relative', 'text-[32px]', 'max-w-full', 'p-4', 'md:min-w-[520px] md:h-max md:py-4 md:px-0'],
  {
    variants: {
      editIsClosed: {
        true: 'min-w-full md:min-w-[740px]',
      },
      noEditIsOpen: {
        true: 'p-0 ',
      },
