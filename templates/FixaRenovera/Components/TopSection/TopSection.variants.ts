...
export const userDataSectionVariants = cva([
  ...
  'md:max-w-[250px] md:w-content md:min-w-[208px] md:ml-0',
  'md:[&_p]:text-[24px]',
])
...
export const styledIntroSectionTitleVariants = cva([
  ...
  'leading-[120%]',
  '!text-[16px]',
  'md:!text-[20px] md:max-w-[450px] md:text-left md:font-bold',
])
...
export const subtitleAndContentWrapperVariants = cva(['flex', 'flex-col', 'w-full', 'gap-4', 'mb-4 md:mb-0', 'md:flex-row md:gap-4 md:items-start md:justify-between'])
