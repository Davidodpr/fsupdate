...
export const styledFlexVariants = cva(['p-0', 'md:py-2 md:pr-2 md:pl-4'], {
  variants: {
    isFromAddress: {
...
export const styledIntroSectionTitleVariants = cva([
  ...
  'leading-[120%]',
  '!text-[18px]',
  'md:!text-[22px] md:max-w-[744px] md:text-left md:font-bold',
])
...
export const headerUspWrapperVariants = cva([
  'p-3',
